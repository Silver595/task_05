export default function HeroSection() {
  return (
    <section
      id="home"
      className="section-spy relative min-h-screen flex items-center justify-center pt-28 overflow-hidden"
    >
      <div className="container mx-auto px- relative z-10 max-w-9xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="text-center lg:text-left order-5 lg:order-1 lg:pl-12">
            ...
            <h1 className="font-display text-[100px] font-bold leading-[1.1] md:leading-[0.9] tracking-tight mb-6 text-slate-900 dark:text-white ">
              <div className="hero-heading-line overflow-hidden ">
                <span className="block">Code.</span>
              </div>
              <div className="hero-heading-line overflow-hidden pb-2 ">
                <span className="relative block text-transparent bg-clip-text bg-gradient-to-r from-primary via-purple-500 to-secondary animate-gradient-x bg-[length:200%_auto] text-[100px] ">
                  Containerize.
                </span>
                <span className="relative block text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-amber-800 to-orange-900 animate-gradient-x bg-[length:200%_auto] text-[100px]">
                  Deploy.
                </span>
              </div>
              <div className="hero-heading-line overflow-hidden text-md left-[30px]">
                <span className="block">Scale.</span>
              </div>
            </h1>

            <p className="hero-description text-lg text-slate-600 dark:text-slate-400 max-w-md text-[15px] mx-auto lg:mx-0 mb-10 leading-relaxed">
          ...
          <div className="hero-image-container relative h-[300px] md:h-[500px] flex items-center justify-center order-1 lg:order-2 perspective-1000">
        ...
        {/* Social links */}
        <div className="flex gap-4 text-2xl text-slate-600 dark:text-slate-400 relative z-10 mt-8 justify-center lg:justify-start lg:pl-12">
          <a
